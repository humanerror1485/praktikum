                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control <?php $__currentLoopData = $errors->all('firstName'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> "
                                type="text" name="firstName" id="firstName" value="<?php echo e(old('firstName')); ?>"
                                placeholder="Enter firstname">
                            <?php if($errors->any('firstName')): ?>
